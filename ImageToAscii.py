...
def convert_Image_To_Ascii(imagePath, asciiRenderWidth=None):
    return image_to_ascii_art(grayscale(resize_for_ascii(imagePath, asciiRenderWidth)), asciiRenderWidth)
