...
# try:
#    file = open("temp/" + "BadAppleForPython2_audio_encoded" + '.txt', 'wb')
#    file.write(b)
#    file.close()
...
# f = open("temp/" + "BadAppleForPython2_audio_encoded" + '.txt', 'rb')
# b = base64.b64decode(f.read())
# f.close()

# try:
#    file = open("temp/" + "BadAppleForPython2_audio_decoded" + '2.mp3', 'wb')
#    file.write(b)
#    file.close()
# except Exception as e:
#    print(e)
