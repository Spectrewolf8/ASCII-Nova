...
fps_count_render_font = pygame.font.Font('../fonts[place fonts to use here]/courier.ttf', 16)
media_controls_render_font = pygame.font.Font('../fonts[place fonts to use here]/courier.ttf', 12)
